...
// Config utilities
export { DEFAULT_CONFIG, DEFAULT_CONFIG_TEXT, DEFAULT_PROPS_SHARED, DEFAULT_PROPS_IMAGE, DEFAULT_PROPS_TEXT, PRESETS, PROP_RANGES, mergeConfig, normalizeConfig, parseColor } from './core/config';
